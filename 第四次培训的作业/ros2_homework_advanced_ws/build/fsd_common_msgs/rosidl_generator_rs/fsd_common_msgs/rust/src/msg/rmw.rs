...
pub struct CarState {
    ...
    pub car_state: super::super::msg::rmw::Pose2D,
...
pub struct CarStateDt {
    ...
    pub car_state_dt: super::super::msg::rmw::Pose2D,
...
#[link(name = "fsd_common_msgs__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_message_type_support_handle__fsd_common_msgs__msg__Pose2D() -> *const std::ffi::c_void;
}

#[link(name = "fsd_common_msgs__rosidl_generator_c")]
extern "C" {
    fn fsd_common_msgs__msg__Pose2D__init(msg: *mut Pose2D) -> bool;
    fn fsd_common_msgs__msg__Pose2D__Sequence__init(seq: *mut rosidl_runtime_rs::Sequence<Pose2D>, size: usize) -> bool;
    fn fsd_common_msgs__msg__Pose2D__Sequence__fini(seq: *mut rosidl_runtime_rs::Sequence<Pose2D>);
    fn fsd_common_msgs__msg__Pose2D__Sequence__copy(in_seq: &rosidl_runtime_rs::Sequence<Pose2D>, out_seq: *mut rosidl_runtime_rs::Sequence<Pose2D>) -> bool;
}

// Corresponds to fsd_common_msgs__msg__Pose2D
#[cfg_attr(feature = "serde", derive(Deserialize, Serialize))]
...
impl Default for Pose2D {
  fn default() -> Self {
    unsafe {
      let mut msg = std::mem::zeroed();
      if !fsd_common_msgs__msg__Pose2D__init(&mut msg as *mut _) {
        panic!("Call to fsd_common_msgs__msg__Pose2D__init() failed");
      }
      msg
    }
  }
...
impl rosidl_runtime_rs::SequenceAlloc for Pose2D {
  fn sequence_init(seq: &mut rosidl_runtime_rs::Sequence<Self>, size: usize) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { fsd_common_msgs__msg__Pose2D__Sequence__init(seq as *mut _, size) }
  }
  fn sequence_fini(seq: &mut rosidl_runtime_rs::Sequence<Self>) {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { fsd_common_msgs__msg__Pose2D__Sequence__fini(seq as *mut _) }
  }
  fn sequence_copy(in_seq: &rosidl_runtime_rs::Sequence<Self>, out_seq: &mut rosidl_runtime_rs::Sequence<Self>) -> bool {
    // SAFETY: This is safe since the pointer is guaranteed to be valid/initialized.
    unsafe { fsd_common_msgs__msg__Pose2D__Sequence__copy(in_seq, out_seq as *mut _) }
  }
}
...
impl rosidl_runtime_rs::RmwMessage for Pose2D where Self: Sized {
  const TYPE_NAME: &'static str = "fsd_common_msgs/msg/Pose2D";
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_message_type_support_handle__fsd_common_msgs__msg__Pose2D() }
  }
}

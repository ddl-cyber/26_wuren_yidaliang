...
#include "fsd_common_msgs/msg/detail/asensing_message__rosidl_typesupport_fastrtps_c.h"
...
using _AsensingMessage__ros_msg_type = fsd_common_msgs__msg__AsensingMessage;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_serialize_fsd_common_msgs__msg__AsensingMessage(
  const fsd_common_msgs__msg__AsensingMessage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_deserialize_fsd_common_msgs__msg__AsensingMessage(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs__msg__AsensingMessage * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t get_serialized_size_fsd_common_msgs__msg__AsensingMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AsensingMessage__ros_msg_type * ros_message = static_cast<const _AsensingMessage__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t max_serialized_size_fsd_common_msgs__msg__AsensingMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsd_common_msgs__msg__AsensingMessage;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_serialize_key_fsd_common_msgs__msg__AsensingMessage(
  const fsd_common_msgs__msg__AsensingMessage * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t get_serialized_size_key_fsd_common_msgs__msg__AsensingMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AsensingMessage__ros_msg_type * ros_message = static_cast<const _AsensingMessage__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t max_serialized_size_key_fsd_common_msgs__msg__AsensingMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fsd_common_msgs__msg__AsensingMessage * ros_message = static_cast<const fsd_common_msgs__msg__AsensingMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fsd_common_msgs__msg__AsensingMessage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fsd_common_msgs__msg__AsensingMessage * ros_message = static_cast<fsd_common_msgs__msg__AsensingMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fsd_common_msgs__msg__AsensingMessage(cdr, ros_message);
}

static uint32_t _AsensingMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fsd_common_msgs__msg__AsensingMessage(
...
static size_t _AsensingMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fsd_common_msgs__msg__AsensingMessage(
...
static message_type_support_callbacks_t __callbacks_AsensingMessage = {
  "fsd_common_msgs::msg",
  "AsensingMessage",
...
static rosidl_message_type_support_t _AsensingMessage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AsensingMessage,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fsd_common_msgs, msg, AsensingMessage)() {
  return &_AsensingMessage__type_support;
}

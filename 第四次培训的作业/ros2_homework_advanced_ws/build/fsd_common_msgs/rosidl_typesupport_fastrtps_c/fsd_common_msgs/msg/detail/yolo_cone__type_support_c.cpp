  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fsd_common_msgs__msg__YoloCone * ros_message = static_cast<const fsd_common_msgs__msg__YoloCone *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fsd_common_msgs__msg__YoloCone(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fsd_common_msgs__msg__YoloCone * ros_message = static_cast<fsd_common_msgs__msg__YoloCone *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fsd_common_msgs__msg__YoloCone(cdr, ros_message);
}

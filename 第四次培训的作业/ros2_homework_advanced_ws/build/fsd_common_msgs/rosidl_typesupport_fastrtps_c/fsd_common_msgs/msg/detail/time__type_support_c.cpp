...
#include "fsd_common_msgs/msg/detail/time__rosidl_typesupport_fastrtps_c.h"
...
using _Time__ros_msg_type = fsd_common_msgs__msg__Time;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_serialize_fsd_common_msgs__msg__Time(
  const fsd_common_msgs__msg__Time * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: sum_compute_time
  {
    cdr << ros_message->sum_compute_time;
  }

  // Field name: control_compute_time
  {
    cdr << ros_message->control_compute_time;
  }

  // Field name: boundary_detector_compute_time
  {
    cdr << ros_message->boundary_detector_compute_time;
  }

  // Field name: line_detector_compute_time
  {
    cdr << ros_message->line_detector_compute_time;
  }

  // Field name: skidpad_detector_compute_time
  {
    cdr << ros_message->skidpad_detector_compute_time;
  }

  // Field name: lidar_detection_compute_time
  {
    cdr << ros_message->lidar_detection_compute_time;
  }

  // Field name: camera_detection_compute_time
  {
    cdr << ros_message->camera_detection_compute_time;
  }

  // Field name: fusion_detection_compute_time
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_deserialize_fsd_common_msgs__msg__Time(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs__msg__Time * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t get_serialized_size_fsd_common_msgs__msg__Time(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t max_serialized_size_fsd_common_msgs__msg__Time(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsd_common_msgs__msg__Time;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_serialize_key_fsd_common_msgs__msg__Time(
  const fsd_common_msgs__msg__Time * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t get_serialized_size_key_fsd_common_msgs__msg__Time(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Time__ros_msg_type * ros_message = static_cast<const _Time__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t max_serialized_size_key_fsd_common_msgs__msg__Time(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fsd_common_msgs__msg__Time * ros_message = static_cast<const fsd_common_msgs__msg__Time *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fsd_common_msgs__msg__Time(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fsd_common_msgs__msg__Time * ros_message = static_cast<fsd_common_msgs__msg__Time *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fsd_common_msgs__msg__Time(cdr, ros_message);
}

static uint32_t _Time__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fsd_common_msgs__msg__Time(
...
static size_t _Time__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fsd_common_msgs__msg__Time(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fsd_common_msgs, msg, Time)() {

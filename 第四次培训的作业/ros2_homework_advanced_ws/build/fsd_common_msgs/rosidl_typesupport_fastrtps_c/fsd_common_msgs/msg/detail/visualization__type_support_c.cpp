...
bool cdr_serialize_fsd_common_msgs__msg__Visualization(
  const fsd_common_msgs__msg__Visualization * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_deserialize_fsd_common_msgs__msg__Visualization(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs__msg__Visualization * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
bool cdr_serialize_key_fsd_common_msgs__msg__Visualization(
  const fsd_common_msgs__msg__Visualization * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t get_serialized_size_key_fsd_common_msgs__msg__Visualization(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Visualization__ros_msg_type * ros_message = static_cast<const _Visualization__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fsd_common_msgs
size_t max_serialized_size_key_fsd_common_msgs__msg__Visualization(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fsd_common_msgs__msg__Visualization * ros_message = static_cast<const fsd_common_msgs__msg__Visualization *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fsd_common_msgs__msg__Visualization(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fsd_common_msgs__msg__Visualization * ros_message = static_cast<fsd_common_msgs__msg__Visualization *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fsd_common_msgs__msg__Visualization(cdr, ros_message);
}

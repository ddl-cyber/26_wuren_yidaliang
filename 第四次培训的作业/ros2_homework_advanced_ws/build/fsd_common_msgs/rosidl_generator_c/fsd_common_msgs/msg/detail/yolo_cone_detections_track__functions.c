...
fsd_common_msgs__msg__YoloConeDetectionsTrack__init(fsd_common_msgs__msg__YoloConeDetectionsTrack * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    fsd_common_msgs__msg__YoloConeDetectionsTrack__fini(msg);
    return false;
  }
  // cone_detections
  if (!fsd_common_msgs__msg__YoloConeTrack__Sequence__init(&msg->cone_detections, 0)) {
    fsd_common_msgs__msg__YoloConeDetectionsTrack__fini(msg);
    return false;
  }
  return true;
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__fini(fsd_common_msgs__msg__YoloConeDetectionsTrack * msg)
{
  ...
  // cone_detections
  fsd_common_msgs__msg__YoloConeTrack__Sequence__fini(&msg->cone_detections);
}
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__are_equal(const fsd_common_msgs__msg__YoloConeDetectionsTrack * lhs, const fsd_common_msgs__msg__YoloConeDetectionsTrack * rhs)
{
  ...
  // cone_detections
  if (!fsd_common_msgs__msg__YoloConeTrack__Sequence__are_equal(
  ...
  fsd_common_msgs__msg__YoloConeDetectionsTrack * output)
{
  ...
  // cone_detections
  if (!fsd_common_msgs__msg__YoloConeTrack__Sequence__copy(
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fsd_common_msgs__msg__YoloConeDetectionsTrack * msg = (fsd_common_msgs__msg__YoloConeDetectionsTrack *)allocator.allocate(sizeof(fsd_common_msgs__msg__YoloConeDetectionsTrack), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fsd_common_msgs__msg__YoloConeDetectionsTrack));
  bool success = fsd_common_msgs__msg__YoloConeDetectionsTrack__init(msg);
  if (!success) {
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence__init(fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fsd_common_msgs__msg__YoloConeDetectionsTrack * data = NULL;

  if (size) {
    data = (fsd_common_msgs__msg__YoloConeDetectionsTrack *)allocator.zero_allocate(size, sizeof(fsd_common_msgs__msg__YoloConeDetectionsTrack), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fsd_common_msgs__msg__YoloConeDetectionsTrack__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        fsd_common_msgs__msg__YoloConeDetectionsTrack__fini(&data[i - 1]);
      }
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence__fini(fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      fsd_common_msgs__msg__YoloConeDetectionsTrack__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence * array = (fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence *)allocator.allocate(sizeof(fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence__init(array, size);
  if (!success) {
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence__destroy(fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence__are_equal(const fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence * lhs, const fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fsd_common_msgs__msg__YoloConeDetectionsTrack__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fsd_common_msgs__msg__YoloConeDetectionsTrack__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fsd_common_msgs__msg__YoloConeDetectionsTrack);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    fsd_common_msgs__msg__YoloConeDetectionsTrack * data =
      (fsd_common_msgs__msg__YoloConeDetectionsTrack *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fsd_common_msgs__msg__YoloConeDetectionsTrack__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          fsd_common_msgs__msg__YoloConeDetectionsTrack__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!fsd_common_msgs__msg__YoloConeDetectionsTrack__copy(

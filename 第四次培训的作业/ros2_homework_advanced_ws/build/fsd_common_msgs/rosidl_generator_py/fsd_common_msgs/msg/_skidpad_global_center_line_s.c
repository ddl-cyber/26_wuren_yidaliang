...
bool fsd_common_msgs__msg__skidpad_global_center_line__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._skidpad_global_center_line", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("SkidpadGlobalCenterLine", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);

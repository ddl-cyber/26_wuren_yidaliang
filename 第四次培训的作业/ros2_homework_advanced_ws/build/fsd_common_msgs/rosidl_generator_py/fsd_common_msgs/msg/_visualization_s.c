...
bool fsd_common_msgs__msg__visualization__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._visualization", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("Visualization", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);

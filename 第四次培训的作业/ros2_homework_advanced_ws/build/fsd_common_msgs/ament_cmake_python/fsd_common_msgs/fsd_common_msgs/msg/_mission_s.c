...
bool fsd_common_msgs__msg__mission__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._mission", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("Mission", (char *)PyUnicode_1BYTE_DATA(name_attr), 7) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  fsd_common_msgs__msg__Mission * ros_message = _ros_message;
  {  // header
...
PyObject * fsd_common_msgs__msg__mission__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fsd_common_msgs.msg._mission");

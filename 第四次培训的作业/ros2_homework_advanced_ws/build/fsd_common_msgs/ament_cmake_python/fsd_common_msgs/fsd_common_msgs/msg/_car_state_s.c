...
bool fsd_common_msgs__msg__car_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._car_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("CarState", (char *)PyUnicode_1BYTE_DATA(name_attr), 8) == 0);
  ...
  {  // car_state
    ...
    if (!fsd_common_msgs__msg__pose2_d__convert_from_py(field, &ros_message->car_state)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * fsd_common_msgs__msg__car_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // car_state
    PyObject * field = NULL;
    field = fsd_common_msgs__msg__pose2_d__convert_to_py(&ros_message->car_state);
    if (!field) {
      return NULL;
    }
    {

...
bool fsd_common_msgs__msg__driving_dynamics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._driving_dynamics", (char *)PyUnicode_1BYTE_DATA(module_attr), 37) == 0);
    assert(strncmp("DrivingDynamics", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);

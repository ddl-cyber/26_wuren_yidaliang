...
bool fsd_common_msgs__msg__can_frames__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._can_frames", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("CanFrames", (char *)PyUnicode_1BYTE_DATA(name_attr), 9) == 0);

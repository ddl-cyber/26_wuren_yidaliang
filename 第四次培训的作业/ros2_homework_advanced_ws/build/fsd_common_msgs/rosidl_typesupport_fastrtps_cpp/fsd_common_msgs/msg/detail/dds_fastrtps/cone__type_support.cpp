...
#include "fsd_common_msgs/msg/detail/cone__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fsd_common_msgs::msg::Cone & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs::msg::Cone & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsd_common_msgs::msg::Cone;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fsd_common_msgs::msg::Cone *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsd_common_msgs::msg::Cone *>(
    untyped_ros_message);
...
{
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_Cone__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsd_common_msgs, msg, Cone)() {
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_Cone__handle;
}

...
#include "fsd_common_msgs/msg/detail/mission__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fsd_common_msgs::msg::Mission & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs::msg::Mission & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsd_common_msgs::msg::Mission;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fsd_common_msgs
max_serialized_size_key_Mission(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const fsd_common_msgs::msg::Mission *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsd_common_msgs::msg::Mission *>(
    untyped_ros_message);
...
{
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_Mission__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsd_common_msgs, msg, Mission)() {
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_Mission__handle;
}

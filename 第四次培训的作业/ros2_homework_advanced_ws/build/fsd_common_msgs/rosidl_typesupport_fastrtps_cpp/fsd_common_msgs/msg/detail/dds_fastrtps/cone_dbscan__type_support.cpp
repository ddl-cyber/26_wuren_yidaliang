  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: corepts
  {
    if (ros_message.corepts.get_backend_type() == "cpu") {
      const std::vector<uint8_t> & vec = ros_message.corepts;
      cdr << vec;
    } else {
      std::vector<uint8_t> vec = ros_message.corepts.to_vector();
      cdr << vec;
    }
  }
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  try {
    ...
    RCUTILS_LOG_ERROR_NAMED(
      "fsd_common_msgs.typesupport_fastrtps_cpp",
  ...
  const rosidl_typesupport_fastrtps_cpp::BufferSerializationContext & serialization_context)
{
  ...
  // Member: corepts
  {
        ...
        cdr, ros_message.corepts, endpoint_info, serialization_context))
    {
      RCUTILS_LOG_ERROR_NAMED(
        "fsd_common_msgs.typesupport_fastrtps_cpp",
        "cdr_deserialize_with_endpoint: failed to deserialize 'corepts'");
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    rosidl_typesupport_fastrtps_cpp::get_buffer_serialized_size(
      ros_message.corepts, current_alignment);

...
#include "fsd_common_msgs/msg/detail/echiev_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fsd_common_msgs::msg::EchievMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs::msg::EchievMessage & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fsd_common_msgs
max_serialized_size_EchievMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsd_common_msgs::msg::EchievMessage;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fsd_common_msgs
max_serialized_size_key_EchievMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const fsd_common_msgs::msg::EchievMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsd_common_msgs::msg::EchievMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EchievMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fsd_common_msgs::msg::EchievMessage *>(
...
static size_t _EchievMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EchievMessage(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EchievMessage__callbacks = {
  "fsd_common_msgs::msg",
  "EchievMessage",
...
static rosidl_message_type_support_t _EchievMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EchievMessage__callbacks,
...
{
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_EchievMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsd_common_msgs, msg, EchievMessage)() {
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_EchievMessage__handle;
}

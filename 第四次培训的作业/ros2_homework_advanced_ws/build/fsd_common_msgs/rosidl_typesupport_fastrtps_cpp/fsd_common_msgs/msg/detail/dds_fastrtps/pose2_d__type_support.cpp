...
#include "fsd_common_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fsd_common_msgs::msg::Pose2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs::msg::Pose2D & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fsd_common_msgs::msg::Pose2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fsd_common_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsd_common_msgs::msg::Pose2D *>(
    untyped_ros_message);
...
{
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsd_common_msgs, msg, Pose2D)() {
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_Pose2D__handle;
}

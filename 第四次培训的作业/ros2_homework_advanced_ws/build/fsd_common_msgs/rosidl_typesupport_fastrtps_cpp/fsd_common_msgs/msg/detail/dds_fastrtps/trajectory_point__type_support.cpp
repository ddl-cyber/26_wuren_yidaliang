...
#include "fsd_common_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const fsd_common_msgs::msg::CarState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const fsd_common_msgs::msg::TrajectoryPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fsd_common_msgs::msg::TrajectoryPoint & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: trajectory_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        fsd_common_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CarState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = fsd_common_msgs::msg::TrajectoryPoint;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: trajectory_point
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        fsd_common_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_CarState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const fsd_common_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fsd_common_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fsd_common_msgs, msg, TrajectoryPoint)() {
  return &fsd_common_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}

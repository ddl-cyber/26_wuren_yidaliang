...
{
  new (message_memory) fsd_common_msgs::msg::Cone(_init);
}

void Cone_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fsd_common_msgs::msg::Cone *>(message_memory);
  typed_message->~Cone();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Cone_message_member_array[4] = {
  {
    "position",  // name
    ...
    offsetof(fsd_common_msgs::msg::Cone, position),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fsd_common_msgs::msg::Cone, color),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fsd_common_msgs::msg::Cone, pose_confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fsd_common_msgs::msg::Cone, color_confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Cone_message_members = {
  ...
  "Cone",  // message name
  4,  // number of fields
  sizeof(fsd_common_msgs::msg::Cone),
...
get_message_type_support_handle<fsd_common_msgs::msg::Cone>()
{
  return &::fsd_common_msgs::msg::rosidl_typesupport_introspection_cpp::Cone_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fsd_common_msgs, msg, Cone)() {
  return &::fsd_common_msgs::msg::rosidl_typesupport_introspection_cpp::Cone_message_type_support_handle;
}

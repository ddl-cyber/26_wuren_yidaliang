...
bool fsd_common_msgs__msg__yolo_cone_track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._yolo_cone_track", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("YoloConeTrack", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);

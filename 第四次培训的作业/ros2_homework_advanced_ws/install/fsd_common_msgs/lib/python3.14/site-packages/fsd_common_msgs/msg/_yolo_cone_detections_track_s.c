...
bool fsd_common_msgs__msg__yolo_cone_detections_track__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fsd_common_msgs.msg._yolo_cone_detections_track", (char *)PyUnicode_1BYTE_DATA(module_attr), 47) == 0);
    assert(strncmp("YoloConeDetectionsTrack", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);

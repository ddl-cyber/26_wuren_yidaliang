  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x2b, 0x6e, 0x16, 0xcb, 0xcd, 0x39, 0x30, 0x79,
      0x9d, 0x1d, 0x5c, 0xc7, 0x98, 0xe7, 0xc7, 0x6b,
      0x58, 0x53, 0x48, 0xfa, 0xb6, 0x33, 0x49, 0xbc,
      0x36, 0xe7, 0xac, 0x87, 0x0a, 0xee, 0x87, 0xd0,
    }};
  return &hash;
}
...
static char fsd_common_msgs__msg__SkidpadGlobalCenterLine__TYPE_NAME[] = "fsd_common_msgs/msg/SkidpadGlobalCenterLine";
...
static char fsd_common_msgs__msg__SkidpadGlobalCenterLine__FIELD_NAME__global_path[] = "global_path";
static char fsd_common_msgs__msg__SkidpadGlobalCenterLine__FIELD_NAME__is_reach_mid[] = "is_reach_mid";

static rosidl_runtime_c__type_description__Field fsd_common_msgs__msg__SkidpadGlobalCenterLine__FIELDS[] = {
  {
    {fsd_common_msgs__msg__SkidpadGlobalCenterLine__FIELD_NAME__global_path, 11, 11},
    {
  ...
  {
    {fsd_common_msgs__msg__SkidpadGlobalCenterLine__FIELD_NAME__is_reach_mid, 12, 12},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription fsd_common_msgs__msg__SkidpadGlobalCenterLine__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {fsd_common_msgs__msg__SkidpadGlobalCenterLine__TYPE_NAME, 43, 43},
      {fsd_common_msgs__msg__SkidpadGlobalCenterLine__FIELDS, 2, 2},
    },
    {fsd_common_msgs__msg__SkidpadGlobalCenterLine__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
fsd_common_msgs__msg__SkidpadGlobalCenterLine__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *fsd_common_msgs__msg__SkidpadGlobalCenterLine__get_individual_type_description_source(NULL),

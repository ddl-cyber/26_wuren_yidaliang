...
// IWYU pragma: private, include "fsd_common_msgs/msg/yolo_cone.hpp"
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, fsd_common_msgs::msg::YoloCone>, int> = 0>
...
template<>
constexpr const char * data_type<fsd_common_msgs::msg::YoloCone>()
{
  return "fsd_common_msgs::msg::YoloCone";
}

template<>
constexpr const char * name<fsd_common_msgs::msg::YoloCone>()
{
  return "fsd_common_msgs/msg/YoloCone";
}
...
template<>
struct MessageTraits<fsd_common_msgs::msg::YoloCone>
{

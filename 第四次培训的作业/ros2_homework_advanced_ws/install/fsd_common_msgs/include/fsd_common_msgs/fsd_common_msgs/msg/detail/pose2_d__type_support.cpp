...
{
  new (message_memory) fsd_common_msgs::msg::Pose2D(_init);
}

void Pose2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fsd_common_msgs::msg::Pose2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose2D_message_member_array[3] = {
  {
    ...
    offsetof(fsd_common_msgs::msg::Pose2D, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fsd_common_msgs::msg::Pose2D, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fsd_common_msgs::msg::Pose2D, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pose2D_message_members = {
  ...
  "Pose2D",  // message name
  3,  // number of fields
  sizeof(fsd_common_msgs::msg::Pose2D),
...
get_message_type_support_handle<fsd_common_msgs::msg::Pose2D>()
{
  return &::fsd_common_msgs::msg::rosidl_typesupport_introspection_cpp::Pose2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fsd_common_msgs, msg, Pose2D)() {
  return &::fsd_common_msgs::msg::rosidl_typesupport_introspection_cpp::Pose2D_message_type_support_handle;
}

...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, fsd_common_msgs::msg::Map>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
    std::forward<T>(msg).header,
    std::forward<T>(msg).cone_yellow,
    std::forward<T>(msg).cone_blue,
    std::forward<T>(msg).cone_red,
    std::forward<T>(msg).cone_unknown);
}
...
template<>
constexpr const char * data_type<fsd_common_msgs::msg::Map>()
{
  return "fsd_common_msgs::msg::Map";
}

template<>
constexpr const char * name<fsd_common_msgs::msg::Map>()
{
  return "fsd_common_msgs/msg/Map";
}
...
template<>
struct MessageTraits<fsd_common_msgs::msg::Map>
{

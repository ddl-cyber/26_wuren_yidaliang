...
// IWYU pragma: private, include "fsd_common_msgs/msg/control_command.h"


#ifndef FSD_COMMON_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
#define FSD_COMMON_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_
 ...
 * calls
 * fsd_common_msgs__msg__ControlCommand__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_fsd_common_msgs
fsd_common_msgs__msg__ControlCommand *
fsd_common_msgs__msg__ControlCommand__create(void);

/// Destroy msg/ControlCommand message.
/**
 * It calls
 * fsd_common_msgs__msg__ControlCommand__fini()
 ...
 * fsd_common_msgs__msg__ControlCommand__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * fsd_common_msgs__msg__ControlCommand__Sequence__fini()
 * on the array,
...
#endif  // FSD_COMMON_MSGS__MSG__DETAIL__CONTROL_COMMAND__FUNCTIONS_H_

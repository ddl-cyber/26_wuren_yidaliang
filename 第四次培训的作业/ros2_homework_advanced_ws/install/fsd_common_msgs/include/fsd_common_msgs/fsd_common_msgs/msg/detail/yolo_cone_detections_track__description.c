  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xe4, 0xbe, 0x49, 0x4c, 0x25, 0x5e, 0x46, 0x6f,
      0xbd, 0x03, 0x43, 0xde, 0xa7, 0x94, 0xb7, 0xbe,
      0x38, 0x10, 0x69, 0xee, 0x18, 0xbe, 0xfd, 0xdf,
      0xd1, 0x9f, 0x32, 0x7c, 0x7e, 0xf4, 0xda, 0x07,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t fsd_common_msgs__msg__YoloConeTrack__EXPECTED_HASH = {1, {
...
static char fsd_common_msgs__msg__YoloConeDetectionsTrack__TYPE_NAME[] = "fsd_common_msgs/msg/YoloConeDetectionsTrack";
...
static char fsd_common_msgs__msg__YoloConeDetectionsTrack__FIELD_NAME__header[] = "header";
static char fsd_common_msgs__msg__YoloConeDetectionsTrack__FIELD_NAME__cone_detections[] = "cone_detections";

static rosidl_runtime_c__type_description__Field fsd_common_msgs__msg__YoloConeDetectionsTrack__FIELDS[] = {
  {
    {fsd_common_msgs__msg__YoloConeDetectionsTrack__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {fsd_common_msgs__msg__YoloConeDetectionsTrack__FIELD_NAME__cone_detections, 15, 15},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription fsd_common_msgs__msg__YoloConeDetectionsTrack__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {fsd_common_msgs__msg__YoloConeDetectionsTrack__TYPE_NAME, 43, 43},
      {fsd_common_msgs__msg__YoloConeDetectionsTrack__FIELDS, 2, 2},
    },
    {fsd_common_msgs__msg__YoloConeDetectionsTrack__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH, builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Time__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&fsd_common_msgs__msg__YoloConeTrack__EXPECTED_HASH, fsd_common_msgs__msg__YoloConeTrack__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[1].fields = fsd_common_msgs__msg__YoloConeTrack__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[3].fields = std_msgs__msg__Float32__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = std_msgs__msg__UInt8__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
fsd_common_msgs__msg__YoloConeDetectionsTrack__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *fsd_common_msgs__msg__YoloConeDetectionsTrack__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[2] = *fsd_common_msgs__msg__YoloConeTrack__get_individual_type_description_source(NULL);
    sources[3] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[4] = *std_msgs__msg__Float32__get_individual_type_description_source(NULL);
    ...
    sources[7] = *std_msgs__msg__UInt8__get_individual_type_description_source(NULL);
    constructed = true;
  }

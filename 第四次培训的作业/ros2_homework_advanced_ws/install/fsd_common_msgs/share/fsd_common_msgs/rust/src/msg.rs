...
pub struct CarState {
    ...
    pub car_state: super::msg::Pose2D,
...
impl rosidl_runtime_rs::Message for CarState {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Owned(msg.header)).into_owned(),
        car_state: super::msg::Pose2D::into_rmw_message(std::borrow::Cow::Owned(msg.car_state)).into_owned(),
        car_state_dt: super::msg::CarStateDt::into_rmw_message(std::borrow::Cow::Owned(msg.car_state_dt)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(&msg.header)).into_owned(),
        car_state: super::msg::Pose2D::into_rmw_message(std::borrow::Cow::Borrowed(&msg.car_state)).into_owned(),
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      header: std_msgs::msg::Header::from_rmw_message(msg.header),
      car_state: super::msg::Pose2D::from_rmw_message(msg.car_state),
...
pub struct CarStateDt {
    ...
    pub car_state_dt: super::msg::Pose2D,
...
impl rosidl_runtime_rs::Message for CarStateDt {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Owned(msg.header)).into_owned(),
        car_state_dt: super::msg::Pose2D::into_rmw_message(std::borrow::Cow::Owned(msg.car_state_dt)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(&msg.header)).into_owned(),
        car_state_dt: super::msg::Pose2D::into_rmw_message(std::borrow::Cow::Borrowed(&msg.car_state_dt)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      header: std_msgs::msg::Header::from_rmw_message(msg.header),
      car_state_dt: super::msg::Pose2D::from_rmw_message(msg.car_state_dt),
    }
  }
}
